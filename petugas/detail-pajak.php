                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="../cetak/cetak1.php" class="card-title btn btn-success mr-2" target="_blank"><i class="fas fa-print"></i> Print</a>
                            <a href="../config/petugas/hapus_semua_pajak.php" class="card-title btn btn-danger"><i class="fas fa-trash"></i> Hapus Semua</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="detailPajak" class="table table-bordered table-striped">
                                <thead>
