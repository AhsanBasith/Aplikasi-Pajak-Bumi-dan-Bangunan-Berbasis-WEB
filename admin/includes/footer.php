    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../config/admin/tambah_admin.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editKwitansi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../config/admin/edit_kwitansi.php" method="post" enctype="multipart/form-data">
